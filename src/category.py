...
from src.exception_class import ZeroRunProduct
        ...
        if isinstance(product, Product):
            try:
                if product.quantity == 0:
                    raise ZeroRunProduct("Количество товара не может быть нулевым")
            except ZeroRunProduct as e:
                print(str(e))
            else:
...
#     print(category1.add_product(product4))
    ...
    # print(category1.middle_price())
    #
    # category10 = Category("Смартфоны",
    #                       "Смартфоны, как средство не только коммуникации, но и получения дополнительных функций для удобства жизни",
    #                       [])
    #
    # print(category10.middle_price())
